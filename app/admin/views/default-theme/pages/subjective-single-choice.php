            ...
            <form method="POST" action="<?=Link::build('single-choice/add/stay-here')?>" enctype="multipart/form-data">
                <div id="mcqs-div">
                    <p style="text-align: center; border-bottom: 1px solid #ccc; margin-bottom: 3.5rem; text-transform: uppercase; color: #646464">SINGLE CHOICE QUESTIONS</p>
                    ...
                    <div class="max-wrap450">
                        ...
                        <div class="row">
                            <input type="radio" name="input-choice" value="opt1" required>
                        ...
                        <div class="row">
                            <input type="radio" name="input-choice" value="opt2">
                        ...
                        <div class="row">
                            <input type="radio" name="input-choice" value="opt3">
                        ...
                        <div class="row">
                            <input type="radio" name="input-choice" value="opt4">
